...
public class AudioController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        string[] bgmName =
        {
            "Audio/BGM/Kirby Mass Attack - Kirby SHMUP Stage 6 Theme", // bgmName[0]
        };
        

        // Resourcesフォルダ内に保存されているオーディオファイルを読み込む
        audioClip = Resources.Load<AudioClip>("Audio/BGM/Kirby Mass Attack - Kirby SHMUP Stage 6 Theme");
